...
export function bindForm(s, { api, onSave }) {
  ...
  s.openAdd = () => { resetForm(); s.addFormType = 'expense'; s.expMode = 'create'; s.showAdd = true }
  s.openDonForm = () => { resetForm(); s.addFormType = 'income'; s.donMode = 'create'; s.showAdd = true; syncDonationControls() }
